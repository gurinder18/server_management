...
$route['all-servers'] = "server/allServerListing";
$route['all-servers/(:num)'] = "server/allServerListing/$1";
...
$route['edit-ip/(:num)'] = "server/editIP/$1";
$route['deleteIP'] = "server/deleteIP";
